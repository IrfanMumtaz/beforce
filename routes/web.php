...
Route::group(['prefix' => 'admin', 'middleware' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::post('/', ['as'=> 'dashboard.get_attendance', 'uses' => 'JoshController@showHome']);
    # crop demo
...
Route::get('cities/{brand?}','EmployeeController@getcities')->name('cities');
Route::get('shops/{city?}','EmployeeController@getstores')->name('shops');
Route::get('reporter/{city?}','EmployeeController@getreporters')->name('reporter');
