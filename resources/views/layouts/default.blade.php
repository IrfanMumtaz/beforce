...
<head>
    ...
    <!--validation css file-->
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/validator/fv.css') }}">
</head>
...
<body>
    ...
    <!--global js end-->
     ...
     <!--start validation script at global level-->
       <script type="text/javascript" src="{{ asset('assets/vendors/validator/multifield.js') }}"></script>
       <script type="text/javascript" src="{{ asset('assets/vendors/validator/validator.js') }}"></script>
<script>
		// initialize the validator function
		validator.message['email'] = 'not a real date duz duz tha';
