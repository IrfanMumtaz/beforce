...
<div class="form-group col-sm-4">
    ...
    {!! Form::text('name', null, ['class' => 'form-control','required','id'=>'shopname']) !!}
...
<div class="form-group col-sm-4">
    ...
    {!! Form::number('latitude', null, ['class' => 'form-control','step' => 'any','required','id'=>'latitude' ]) !!}
...
<div class="form-group col-sm-4">
    ...
    {!! Form::number('longitude', null, ['class' => 'form-control','step' => 'any','required','id'=>'longitude']) !!}
...
<script>
      ...
      function initMap() {
          var latitude=<?php echo $stores->lat ?>;
          var longitude=<?php echo $stores->lng ?>;
          var shoptitle='<?php echo $stores->shopname; ?>';
    ...
    <script  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDV4k8Ka_EuBhfcQ1EpZpNzuoFxAWb9lmQ&callback=initMap&v=3"  type="text/javascript"></script>
<script>
